...
def jacobi_numba(u0, interior_mask, max_iter, atol):
    ...
    for _ in range(max_iter):
        ...
        # i loops over rows, j loops over columns
        # j is inner to match row-major memory layout
...
def main():
    parser = argparse.ArgumentParser(
        description="Wall-heating simulation using Numba CPU JIT Jacobi solver."
    )
    ...
    # Warm-up compilation once before timing parallel work too heavily
